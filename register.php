    ...
    if (empty($username) || empty($email) || empty($password)) {
        ...
        if ($stmt->fetch()) {
            ...
            if ($insert->execute([$username, $email, $hashed_password])) {
                ...
                // Log activity
                $logStmt = $pdo->prepare("INSERT INTO activity_logs (user_id, action) VALUES (?, 'Registered account')");
                $logStmt->execute([$user_id]);
                
                $success = 'Registration successful! You can now sign in.';
            } else {
                $errorInfo = $insert->errorInfo();
                $error = 'Database Error: ' . htmlspecialchars($errorInfo[2]);
            }
        }
    }
}
...
<head>
    ...
    <title>Register - task.n1space.com</title>
...
<body class="bg-gray-50 flex items-center justify-center min-h-screen bg-pattern relative overflow-y-auto py-10">
    ...
    <div class="w-full max-w-md p-8 relative z-10">
        <div class="bg-white/80 backdrop-blur-xl rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/20 p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2 text-sm">Start managing your tasks efficiently.</p>
            </div>
            ...
            <?php if($success): ?>
                <div class="bg-green-50 text-green-600 p-4 rounded-lg mb-6 text-sm flex items-start gap-3 border border-green-100">
            ...
            <form method="POST" action="register.php" class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" required class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white/50" placeholder="John Doe">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" required class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white/50" placeholder="name@company.com">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" required class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white/50" placeholder="••••••••">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="confirm_password" required class="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white/50" placeholder="••••••••">
                    </div>
                </div>
            ...
            <div class="mt-8 text-center text-sm text-gray-500">
                ...
                <a href="login.php" class="font-medium text-blue-600 hover:text-blue-500 transition-colors">Sign in</a>
            </div>
        </div>
    </div>
</body>
