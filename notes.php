    ...
    <header class="h-20 bg-white dark:bg-[#0B1120] border-b border-gray-250 dark:border-gray-800/50 flex items-center justify-between px-4 sm:px-6 shrink-0 transition-colors">
        <div class="flex items-center gap-2 sm:gap-4 min-w-0">
            ...
            <h1 class="text-base sm:text-xl font-bold text-gray-800 dark:text-white flex items-center gap-1.5 sm:gap-2 min-w-0">
                <i class="ph-fill ph-notebook text-cyan-400 shrink-0"></i> <span class="truncate">Notes</span>
            </h1>
        </div>
        ...
        <div class="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <button onclick="openNoteModal()" class="p-2.5 sm:px-4 sm:py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-colors flex items-center gap-2 shadow-sm shrink-0" title="New Note">
                <i class="ph ph-plus"></i> <span class="hidden sm:inline">New Note</span>
            </button>
        </div>
    </header>
